...
const BALL_CONFIG = [
  { level: 1, radius: 25, image: '/avatars/stefan2.png', color: '#8B5CF6', score: 10, name: 'stefan' },
  { level: 2, radius: 28, image: '/avatars/raintaro2.png', color: '#3B82F6', score: 20, name: 'raintaro' },
  { level: 3, radius: 32, image: '/avatars/itoshi2.png', color: '#EC4899', score: 30, name: 'itoshi' },
  { level: 4, radius: 36, image: '/avatars/hinata1.png', color: '#F59E0B', score: 40, name: 'hinata' },
  { level: 5, radius: 40, image: '/avatars/majorproject2.png', color: '#10B981', score: 50, name: 'majorproject' },
  { level: 6, radius: 44, image: '/avatars/jezz1.png', color: '#EF4444', score: 60, name: 'jezz' },
  { level: 7, radius: 48, image: '/avatars/dunken2.png', color: '#8B5CF6', score: 70, name: 'dunken' },
  { level: 8, radius: 52, image: '/avatars/josh2.png', color: '#3B82F6', score: 80, name: 'josh' },
  { level: 9, radius: 56, image: '/avatars/niraj2.png', color: '#EC4899', score: 90, name: 'niraj' },
  { level: 10, radius: 60, image: '/avatars/ritual2.png', color: '#F59E0B', score: 100, name: 'ritual' },
];
